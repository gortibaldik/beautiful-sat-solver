                  ...
                  <section v-if="problem_parameters && problem_parameters.length > 0" style="margin-top: 10px; margin-bottom: 10px">
                    ...
                    >
                      <mdb-row class="parameterSelector justify-content-between">
                        ...
                        class="align-self-center">
                          <select class="browser-default custom-select benchmarkPossibilities special-width" v-model="parameter.default">
                            <option v-for="(value, index) in parameter.options" :key="index">
                              {{value}}
                            </option>
                          </select>
                        </div>
                        <div v-if="parameter.type=='multiline'"
                        class="align-self-center">
                          <textarea v-model="parameter.default" class="benchmarkPossibilities multiline-input"></textarea>
                        </div> 
                      </mdb-row>
                    </section>
                  </section>
